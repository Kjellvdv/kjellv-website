...
title: "About Kjell Vandevyvere"
description: "(Read about my background) Recent activities Last update: 7 May In the past few months, I’ve been building a lot with Claude Code – the most useful things are…"
---

([Read about my background](#background))

## Recent activities

*Last update:* 7 May

In the past few months, I’ve been [building a lot with Claude Code](http://vibing.kjellv.com) – the most useful things are a GTM dashboard that helps me define positioning, messaging etc fast for my clients or new brands. I also have a goal tracker that tracks weekly, quarterly goals and daily activities. It’s been very useful to reflect and keep track of what I do.

On a professional basis, things are going pretty well with commitments across Willow, ZYGO and SOFICO. It’s a nice mix of start-up, scale-up and more established company. But all are moving forward with AI, which is cool.

Next to this, I’ve bought a new domain for a new project that might actually be worth the effort. I haven’t started yet but hope to get an mvp ready soon.
...
Then in October 2021, I moved back to Belgium and finally made the call. I became a full-time freelancer. You can read more about my story [here](https://kjellv.com/short-bio/).

## Archive

### 21 January 2026

My wife said something about 9-year cycles closing last year and new ones opening this year. While I think that’s BS, it could somehow make sense. 9 years ago I finished University and moved abroad. It was the first year of really standing on my own two feet. Shortly after I also met my wife.

Since new cycles are supposed to be starting now, I joked that this would be the year we’d separate then. She didn’t like it. But it does feel like a big year. For one, we’re definitely going to move again, but where? We’ve mainly been looking in the same area, but what if we made a more drastic decision?

And then there’s AI and vibe coding. (I know, I know). But for the first time ever I’m brimming with ideas and I can execute on them too. Starting slowly with the easiest stuff — personal wardrobe app anyone? — I’m gradually learning how to give better input and how to get better output. When to use ChatGPT, Replit or Claude Code. It’s one hell of an experience. And there’s one hell of a ride ahead.

In other news, I’ve recently spent a lot of time organising my notes in Obsidian. It feels strangely amazing to know all my “knowledge” from marketing to book quotes sits in one place. I’m still not done, though, but I’m getting there.

The great thing about this organising work is that it resurfaced some great books I’ve read or added to my reading list. I’m quite ambitious: 48 — feel free to ask about the list. I’m already behind schedule, of course.

But even more exciting, I’m tinkering with the idea of turning all these Obsidian notes into my personal knowledge agent.

“Hey, what quotes did I highlight in Building a StoryBrand and what other marketing notes are related to that?”

Shouldn’t be that hard, right?

### 4 September 2025

My main focus right now is finding space for myself. While work and family seem to be in balance, there’s little time for myself. The three things I want to dedicate more time to are podcasts, reading and sports.

In terms of podcasts, I’ve recently launched “[The Impact Through Social Media Podcast](http://instagram.com/itsmpodcast)“. I created it as a way of combining my personal interests with a greater cause and my work.

In terms of reading, I’m still stuck on Read, Write, Own – not because it’s bad, but because I make very slow progress. (Am I sounding like AI now?) The book is actually good and thought-provoking so I only want to read when I’m in the right state of mind.

In terms of sports, let’s not talk about it.

Give [www.heywill.ai](http://heywill.ai) a go while you’re here. OK?

### *17 April 202*5

I started the year with lots of ambitious ideas, as it usually goes. In January, I exercised almost daily. In February, [I didn’t drink any alcohol](https://kjellv.com/ranking-non-alocholic-beverages/). In March, I already stopped with my monthly challenges. With two kids and professional deadlines, it just didn’t work anymore.

Professionaly, it’s been super exciting with the launch of [Will](http://www.heywill.ai), Willow’s AI Agent for LinkedIn. We presented him first at SuperNova, a tech festival in Antwerp. And we then launched Will for the big public on [Product Hunt](https://www.producthunt.com/posts/will-manages-your-social-media).

Otherwise, I’ve just not had the time for side projects even though I was very ambitious there at the start of the year. I can barely keep up with the ten newsletters I’m subscribed to. Ok, I have 200+ unread ones.

### 9 December 2024

The last few months have been super busy. 90% of my time goes to work and my kids. The other 10% goes to making bad decisions. But when so much of my time is taken up by energy-consuming activities, it’s maybe better to switch it off during the remaining hours.

I’m really eager to start creating stuff again and to share my knowledge with others, but it’s hard to commit. Hopefully next year!
...
| Clients | 12 | 19 | 24 |
| Projects | 33 | 38 | 91 |
| Website projects | 13 | 8 | 10\* |
| Blog posts | 44 | 50 | 51\* |
| Other projects/income sources | 4 | 10 | 15\* |
| Percentage of target revenue | 130% | 53,2% | 65,3% |

\* unsure about the numbers. Lots of projects were split into multiple invoices.

### 16 August 2024

I’ve tried (and failed) a few challenges this year: no alcohol, no meat, daily walks, less sugar … In July, I tried daily sports. Even though I did start doing exercise more regularly, daily is difficult. Exercising at home is near impossible with two small kids around. This month I’m not even doing a challenge. After the summer, I’ll focus on mental challenges rather than health ones. Daily yoga and daily creative writing are still on my list.

In terms of work, the summer has been pretty crazy. I’ve been trying to combine multiple projects with some family activities. It’s stressful but not impossible. However, it has left me with very little time to read or work on side-projects. I’m only writing this now because I woke up at 4:45 am and couldn’t sleep anymore.

In fact, I’ve decided to start getting up between 5 and 5:30 am so I can get some things done before the kids wake up. They’re finally sleeping rather consistently through the night (should I say this out loud?). It’s the third day I’ve started early, and I’ve already finished a book that had been lying around for months (Man’s Search for Meaning). I’ve also finally read the magazine that I receive weekly but barely open. And now I’m working on my website. Pretty good results. Waking up early definitely feels more productive than working a bit longer at night.
...
- [Why this job?](#why)
- [What about freelance copywriting](#freelance)?
- [What does this mean for other clients](#clients)?
- [What does this mean for people who want to start working with me](#start)?
- [What does this mean for side projects](#side) like [The Copy Galaxy](https://thecopygalaxy.com)?
- How about the [veggie challenge](#veggie) you’re doing this month? (I know, this is a personal update.)
...
On my free days, I’ll continue writing blog content for [Accountable](https://accountable.eu/). Next month, I’ll also be starting a new project with a global SaaS company. Other clients that work with me on an ad-hoc basis, can still count on me as well, but they might need to plan a bit more in advance.
...
I’m also thinking about taking requests for hero section/home page reviews @ [The Copy Galaxy.](https://thecopygalaxy.com) I’m planning to make it very affordable but haven’t figured out the details yet.
...
This month, I’ll be doing a [veggie challenge](https://kjellv.com/veggie-challenge/). I’m going to start on the second of the month again because we still have homemade hamburgers in the fridge. I wonder if this is going to have some sort of impact on me.
...
| Clients | 5 | 19 | 24 |
| Projects | 8 | 38 | 91 |
| Website projects | 2 | 8 | 10\* |
| Blog posts | 13 | 50 | 51\* |
| Other projects/income sources | 2 | 10 | 15\* |
