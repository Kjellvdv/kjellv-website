---
title: "Will: taking Willow's WhatsApp agent for LinkedIn from a blank page to launch"
summary: "Go-to-market for a Willow spin-off with no marketing yet: the promise, the site, tracking inside WhatsApp, and a launch whose lessons fed Willow Create."
numbers:
  - value: "1,400+"
    label: "free trials started since the April 2025 launch"
quote:
  text: "When we were in the middle of launching our AI Agent \"Will\" it required a lot of cross-team collaboration and it isn't easy for an average marketer to understand the ins and outs of an AI Agent. Kjell however was able to effortlessly create and execute the marketing strategy for Will across different social media platforms, which drove in huge amounts of traffic to our AI Agent on the launch day."
  name: "Farhan Ahmad"
...
![Will's first page: an AI agent for social media, with a "Get priority access" button](./will/will-before.png)
...
![heywill.ai around launch: "No time for LinkedIn? Just WhatsApp Will"](./will/will-home.png)
