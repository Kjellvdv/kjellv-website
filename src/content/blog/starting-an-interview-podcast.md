---
title: "How to Start an Interview Podcast"
meta_description: "Tips and tricks on how to start an interview podcast. Based on my experiences, conversations and reading of relevant books."
category: Marketing
status: published
...
After only twelve episodes, I scheduled [Rob Fitzpatrick](https://open.spotify.com/episode/1HBtkWINOvZ7HYzLFbjWm8?si=Ar3ImxNTRw-FL3YeZG8Vlg) and [David Kadavy](https://open.spotify.com/episode/3D7j3YHh4wzIfA6rtKeW0l?si=9_RTnK6PRMGgyBDignuWuw), whom I consider exciting names in the self-publishing scene.

![](/blog/starting-an-interview-podcast/Rob-Fitz-YT-1024x576.png)

YouTube cover of the Rob Fitzpatrick episode.

In the final episodes, I had the honour to receive one hour of [Steph Smith](https://open.spotify.com/episode/0sZGC9k7GZ9APvYUkaZACU?si=4iPFBVoCSkOQW_CEIEi_-w)’s and [Andrew Warner](https://open.spotify.com/episode/5e9Ys0bsEMgNZaIwTdPg59?si=oJLknJapRf6NgPCCT2yj1A)’s time. These people had direct connections with some of my biggest idols.
...
- From [Michele Hansen](https://deployempathy.com/), I learned to let the questions hang. Don’t be afraid to leave an awkward silence that motivates your guest to keep talking. (You can always edit the audio later).
- From [Bob Manfreda and Adam Putterman](https://mbacoffeechats.com/), I learned one of my favourite questions: “What’s something I didn’t ask but should have asked.” Try it in all your interviews, even those that aren’t podcast-related.
- From [Andrew Warner](http://stopaskingquestions.co/), I learned not to ask any “favourite” questions. It puts people on the spot. I shot a few at him anyway and got the expected result: Andrew took a while to consider the options, and the conversation drifted off.

For more interview tips, here’s [Stanford’s one-page interview guide](https://practices.learningaccelerator.org/artifacts/stanford-d-school-empathy-interview-guide).
...
- Will there be a pre-interview? Some guests might expect this. April Dunford, for example, asked me if we were doing the actual interview or just a pre-interview. Pretty embarrassing indeed. (More about pre-interviews in Andrew Warner’s [Stop Asking Questions](http://stopaskingquestions.co/))
...
With the risk of venturing into a higher level of editing, fellow podcaster [Edu Nuñez](https://open.spotify.com/show/00r5ZMEnTVW4jl1Lo6nAj9) recommends adding a few highlights, some music and a short personal introduction to the start of each episode.

I used the following tools to record, edit and publish (free unless otherwise stated):

1. [Calendly](https://calendly.com/) to schedule time with my guests. Ideally, they find a time on my schedule so they automatically get a link for the Zoom call that I’ll record.
2. [Zoom](https://zoom.us/) to have the conversations and grab the audio. I only learned in the last episode how to record two audio channels.\* I got a paid plan for one month when I conducted two double interviews.
3. [Audacity](https://www.audacityteam.org/) to edit the audio. You can download this tool for free, but you may need to add the free [FFmpeg Library](https://manual.audacityteam.org/man/faq_installing_the_ffmpeg_import_export_library.html) to be able to upload more file extensions like M4A or WMA.
4. [Descript](https://www.descript.com/) to make audio clips. I only got this near the end, but I could’ve used this to edit audio. It’s easier to use because it gives you a very visual representation of the conversation, but other options are more limited. I got the pro plan for one month and might have continued using it in the future.
5. [Anchor.fm](https://anchor.fm/dashboard) to create and upload my podcast episodes. (alternatives: [Buzzsprout](https://www.buzzsprout.com/), [Riverside.fm](https://riverside.fm/))
...
![zero to sold quote by aurasky](https://lh4.googleusercontent.com/leFfVAHrz8S-9EVcaZi7WAUDNzVtOXvn34PgOr8Ppsxf85LOOL6tdLbbC_kku7sdV6g_LxHL8wzOYkKELirAaxztTH2y7knDcrFHgpl7PTo4_FeI43pJNn5qtzH2B5HDmZ7SpPT2)

*Visual by Sathya for* [*Zero to Sold*](https://gumroad.com/a/762254451/irsgh) *(More in the* [*Yellow Visual*](https://gumroad.com/a/223548531/whAbjx)*)*
...
I used [anchor.fm](https://anchor.fm/) which made the podcast immediately available on Spotify and a few other places.

But that doesn’t include Apple Podcasts and many smaller players. To add your podcast to these other platforms, you need to find your RSS link in your host platform and add this to other platforms like [Apple Connect](https://podcastsconnect.apple.com/) (which also adds your podcast to Overcast).
...
- [Radio Public](https://radiopublic.com/)
...
- [Alpha podcasters](https://alphapodcasters.com/)

Finally, Steph Smith has paid a community for content creators and podcasters. In [Doing Content Right](https://gumroad.com/a/536106099/qblpG) (affiliate link) you pay once for lifetime access to updates and community events.
...
I won’t turn this into a newsletter course as well, so if you want to learn more about newsletters, [Growth Currency](https://growthcurrency.substack.com/) is a good place to start.
...
> Learn how to write more, publish without problems and market your book in under one-hour conversations.  
>   
> Introducing the Coffee & Pens Podcast [pic.twitter.com/cZYA6HlmeH](https://t.co/cZYA6HlmeH)
>
> — Coffee & Pens 🎙 Writing made easy. (@CoffeePens) [August 19, 2021](https://twitter.com/CoffeePens/status/1428404537950449668?ref_src=twsrc%5Etfw)

Of course, all of this is a lot of work without tools. I used [Hypefury](https://hypefury.com/?via=kjell-vandevyvere37) to schedule this content. Even though I abandoned the podcast more than a month ago, content is still being published or retweeted daily. For threads, I prefer [Typefully](https://typefully.com/?via=kjell).
...
For a better example, check [Mike Sczcesniak](https://www.instagram.com/mikeszczesniak/) from the Results Engine podcast.
