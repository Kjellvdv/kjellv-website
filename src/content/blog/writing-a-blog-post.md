---
title: "How I Write Long-form Content"
meta_description: "A step by step guide to writing a blog post or essay: from idea generation and research to putting everything together."
category: Writing
status: published
...
I start with **SEO research** for which I use [Brandoverflow](https://www.brandoverflow.com/) (no affiliate) and Google Search.

The next step is **topic research**. This means I will read the top 3–5 search results for the main keyword and do a quick search in my own notes in [Evernote](https://evernote.com/) (no affiliate).
