---
title: "Your design decisions are conversion decisions"
meta_description: "Great copy only works if people can find it and act on it. Buttons, contrast, menus and choice counts: the design fixes that get your words read."
category: Marketing
...
- Good contrast between the button and the background
- Good contrast between the button and its own text
- A shape that isn't repeated anywhere else on the page
- An arrow or icon to signal that something happens next
- One primary button that's louder than every other clickable thing
