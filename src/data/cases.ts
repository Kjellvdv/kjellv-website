...
export const cases: ClientCase[] = [
  ...
  },
  {
    ...
    updated: '2026-07',
    what:
      'Will is Willow\'s AI agent for LinkedIn, and it runs entirely through WhatsApp. Send a voice note or a few bullets and it comes back with a post in your own voice, having read your last fifty to learn how you write. No dashboard, no new app to open. Over 1,400 people have started a free trial so far.',
    did: [
      'Coordinated the Product Hunt launch, which didn\'t make the day\'s top ten or pick up a feature',
      ...
      'Made the YouTube explainers, with a friend helping on the more entertaining videos',
