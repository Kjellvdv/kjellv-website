...
export default defineConfig({
  ...
  // GitHub Pages serves every route as a directory index and 301s the unslashed
  // URL to the slashed one, so the slashed form is the only one that answers 200.
  // Pinning this keeps dev and preview honest about it, and keeps canonicals,
  // the sitemap and internal links naming the same URL.
